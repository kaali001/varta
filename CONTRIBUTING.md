...
## **Issue Report/Add new feature Process**

1. Go to the project's issues.
2. Give proper description for the issues.
3. Wait for till someone is looking into it !.
4. Start working on issue only after you got assigned that issue 🚀.
...
1. [Fork](https://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git remote add upstream https://github.com/kaali001/varta.git
   ```
...
3. Create a new branch from the master branch to contain your changes.
   ...
   ```bash
   git checkout -b john/138/Login-functionality
   ```
...
2. **Clone the Repository:**
   - If you haven't cloned the varta repository yet, you can do so by clicking on the "File" menu and selecting "Clone Repository."
   - Choose the varta repository from the list of repositories on GitHub and clone it to your local machine.
...
7. **Create a Pull Request:**
  - Go to the GitHub website and navigate to your fork of the varta repository.
...
9. **Wait for Review:**
    Your pull request will now be available for review by the project maintainers. They may provide feedback or ask for changes before merging your pull request into the master branch of the varta repository.
